-- Materialized View: mv_leaderboard_stats_2_0_0_attachment_filtered
-- Description: Pre-aggregated leaderboard statistics for evaluator version 2.0.0
...
--
-- Refresh: Run REFRESH MATERIALIZED VIEW CONCURRENTLY mv_leaderboard_stats_2_0_0_attachment_filtered;
